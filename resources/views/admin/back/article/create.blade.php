...
@section('content')
          ...
          @endif
              ...
              <form method="post" action="{{ _route('admin:article.store') }}" accept-charset="utf-8">
              {!! csrf_field() !!}
                    ...
                    <div class="tab-pane active" id="tab_1">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input type="checkbox" name="flag[]" value="{{ $k }}">
                      ...
                      <div class="form-group">
                        ...
                        <div id="mdeditor">
                          <textarea class="form-control" name="content" style="display:none;">{{ old('content', '> hello editor.md') }}</textarea>
                        </div>
                      </div>
                    </div><!-- /.tab-pane -->
